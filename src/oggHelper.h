...
public:
	...
	BOOL encode(const char* file_in, const char* file_out, EncodeSetting es, VorbisComment ivc/*, WNDPROC callbackproc*/);
	//The actual decode function
	BOOL decode(const char* file_in, const char* file_out/*, WNDPROC callbackproc*/);
